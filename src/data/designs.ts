...
export const designData: DesignType[] = [
  {
    ...
    description: "สไตล์พิกเซลแบบคลาสสิก เรียบง่าย ใช้สีจำกัด เหมือนเกมยุค NES, Game Boy หรือ Atari ที่มีเสน่ห์แบบดั้งเดิม",
  ...
  },
  {
    ...
    description: "รายละเอียดเยอะขึ้นกว่าดั้งเดิม แต่ยังคงความเป็นพิกเซลที่ดู \"เกมยุคเก่า\" เหมือนงาน Super Nintendo หรือ Sega",
    category: "Retro Gaming",
  ...
  {
    id: "pixel-art-32bit",
    title: "Pixel Art (32-bit)",
    description: "ความละเอียดสูงขึ้น มีการใช้สีเยอะขึ้น คล้ายเกมยุค PlayStation 1 หรือ Arcade ขั้นสูง",
    category: "Retro Gaming", 
  ...
  },
  {
    ...
    title: "Chiptune / Retro Wave Visual",
    description: "เอาสีและกราฟิกจากยุค 80–90 มาใช้ เช่น โทนสี \"นีออน\" + เส้นกริดแบบ Tron + ฟอนต์ดิจิทัล",
    category: "Synthwave",
  ...
  },
  {
    id: "low-poly-3d",
    title: "Low-Poly 3D",
    description: "คล้ายกับ 8-bit แต่เป็นเวอร์ชันสามมิติที่ใช้รูปทรงเหลี่ยม ๆ ดูเป็นงาน polygon สวยเรียบง่าย",
  ...
  },
  {
    ...
    title: "Minimal Vector Pixel-inspired",
    description: "เอาความเรียบง่ายแบบพิกเซลมาทำเป็นไอคอนหรือเวกเตอร์ เรียบแต่ยังให้อารมณ์ retro",
  ...
  {
    id: "cyberpunk-ui",
    title: "Cyberpunk UI/HUD",
    description: "ดีไซน์อินเตอร์เฟสแบบไซเบอร์พังค์ มีหน้าจอ HUD, สีนีออน, และเส้นขอบแหลมคม",
  ...
  },
  {
    ...
    description: "ศิลปะแบบ Vaporwave ด้วยสีชมพู-ม่วง, ปาล์ม, รูปปั้นกรีก, และ VHS glitch effects",
    category: "Vaporwave",
  ...
  },
  {
    id: "neon-noir",
    title: "Neon Noir",
    description: "การผสมผสานระหว่างความมืดของ Film Noir กับแสงนีออนสีสดใส สร้างบรรยากาศลึกลับ",
    category: "Cinematic",
  ...
  {
    id: "glitch-art",
    title: "Glitch Art Digital",
    description: "ศิลปะที่จำลอง error ของระบบดิจิทัล เช่น pixel corruption, color shifting, และ data moshing",
  ...
  },
  {
    ...
    description: "เอฟเฟกต์โครเมียมแบบโฮโลแกรมที่เปลี่ยนสีตามมุมมอง สะท้อนแสงแบบอิริเดสเซนต์",
  ...
  {
    id: "ascii-art-modern",
    title: "Modern ASCII Art",
    description: "ASCII Art แบบใหม่ที่ใช้ Unicode characters สร้างภาพที่ซับซ้อนและมีรายละเอียดมากขึ้น",
    category: "Text Art",
  ...
  },
  {
    ...
    description: "เอฟเฟกต์ Digital Rain แบบ Matrix ด้วยตัวอักษรญี่ปุ่นและสีเขียวนีออน",
    category: "Cinematic",
